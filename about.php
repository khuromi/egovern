...
<body>
    ...
    <nav class="navbar bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand link-light" href="login.php">
                <i class="fa fa-home" aria-hidden="true"></i> egovern
            </a>
            <ul class="navbar-nav">
                <li class="nav-item">
...
With our strong fanh coupled with total trat in model svommunity. God, we work together to make our larangay a
<br>
a. To develop our infrastructure us
<br>
h. Provide harangay facilities or war economic development servis 4. Provide ratur means of transporting goods and services by improving farm to market roads
<br>
d. Mantor maintain peace and onder Tih putively parista in Clean and Gesen Program Actmitte
<br>
we shall strive to uphold the same We promise date and perform arу рікся of work so the bear four of our baranger by analysing dilipornly rability</p>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card border-0 shadow">
                            ...
                            <div class="card-body text-center">
                                <h5 class="card-title mb-0"> ADRIOSOLA, ANGIELYN</h5>
                                <div class="card-text text-black-50 "><br>Documenter/Technical Writer</div>
                            </div>
                        </div>
                    </div>
					</div>
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card border-0 shadow">
                            ...
                            <div class="card-body text-center">
                                <h5 class="card-title mb-0">CUNANAN, ELYZA V.</h5>
                                <div class="card-text text-black-50"><br> QA / Tester <br> Documenter/Technical Writer</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card border-0 shadow">
                            <img src="assets/img/harry.jpg" class="card-img-top" alt="...">
                            <div class="card-body text-center">
                                <h5 class="card-title mb-0">MARK LAURENCE HARRY</h5>
                                <div class="card-text text-black-50"> <br> Documenter/Technical Writer</div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <footer class="footer">
            <p>&copy; eGovern System Management - Salcedo Ilocos Sur
                <?= date("Y") ?>
            </p>
        </footer>
    </div>
